        ...
        for (int i = 0; i < numberRateTests; i++) {
            ...
            try {
                ...
                for (int k = 0; k < reducedStartHours[i].length; k++) {
                    reducedPeriods.add(i,
                            new Period(reducedStartHours[i][k], reducedEndHours[i][k]));
                    normalPeriods.add(i, new Period(normalStartHours[i][k], normalEndHours[i][k]));
                    System.out.println(k);
                }
                // System.out.print( " - " + periodsToTest.get(index).getStartHour() + ", " +
                // periodsToTest.get(index).getEndHour());
